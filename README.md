...
|---:|---:|---:|---:|
| **90,702** lines | **191,465** lines in 207 files | **2,049** declared | **54** Alembic revisions |

<sub>Measured from the private product repository at commit `cbd7dde` (2026-09-25); refreshed 2026-09-25. 294,065 lines of code in total across application, tests, migrations, and infrastructure; 303 commits since 2026-07-02, 187 in the last 30 days. Test cases: 1,547 pytest (257 parametrized) and 502 Node test-runner cases. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
