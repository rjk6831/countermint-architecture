...
|---:|---:|---:|---:|
| **91,404** lines | **192,472** lines in 210 files | **2,085** declared | **55** Alembic revisions |

<sub>Measured from the private product repository at commit `0b16372` (2026-09-25); refreshed 2026-09-25. 295,835 lines of code in total across application, tests, migrations, and infrastructure; 314 commits since 2026-07-02, 198 in the last 30 days. Test cases: 1,575 pytest (260 parametrized) and 510 Node test-runner cases. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
