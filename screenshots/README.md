...
See the [product tour](../docs/product-tour.md) for the screenshots in context.
...
## Earlier private-beta screens

These screens predate the August 2026 interface. Their workflows and versioning rules are still current unless noted otherwise.
